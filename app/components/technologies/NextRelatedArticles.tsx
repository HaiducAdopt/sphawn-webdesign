...
export default function NextRelatedArticles() {
  const t = useTranslations("NextJsPage.relatedArticles");
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-3">
          {articles.map((article) => (
            <article
              key={article.slug}
              className="flex flex-col rounded-3xl border border-white/10 bg-[#07111f] p-7"
            >
