export default function Hero() {
  return (
    <main className="relative min-h-screen bg-[#0A1A2F] text-white overflow-hidden">
      ...
      {/* CONȚINUT ALINIAT LA „DUNGILE” DIN FIGMA */}
      <div
        className="
            ...
            <div className="text-white">
              ...
              >
                <div className="hero-line-wrapper">
                  <span className="hero-line hero-line-1">LET&apos;S</span>
                </div>
                <div className="hero-line-wrapper">
                  <span className="hero-line hero-line-2">GO</span>
                </div>
                <div className="hero-line-wrapper">
                  <span className="hero-line hero-line-3">ONLINE</span>
                </div>
              </h1>
